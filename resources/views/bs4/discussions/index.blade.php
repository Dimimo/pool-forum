    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <ul class="list-unstyled">
                ...
                <li>
                    <a class="badge" style="color: {{$tag->color}}; background: {{$tag->background_color}}" href="javascript:void(0)" onclick="event.preventDefault();tag('{{$tag->slug}}')">
                        {{$tag->name}}
                    </a>
                </li>
                @endif
        ...
        <div class="col-md-9">
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr class="bg-dark">
                        ...
                        <td class="text-right text-muted">
                            ...
                            <span class="dropdown show ml-5">
                                <i class="fas fa-ellipsis-v" id="discussion-options-{{$discussion->id}}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="cursor: pointer;"></i>
                    ...
                    @endforeach
                    @if(count($stickies) < 1 && count($discussions) < 1) <p>No discussions</p>
                        @endif
                </tbody>
            </table>
        </div>
